...
var mergeHeaders = exports.mergeHeaders = function mergeHeaders(defaults, custom) {
  ...
  // TODO: this function doesn't follow the "do one thing and do it well" philosophy,
  //    as it also extends obj by the entries of toMerge
  function _normalizeKeys(toMerge) {
    function _normalizeKey(key) {
      return key.split('-').map(function (part) {
          // TODO: non-first letters of each part should be lowercase
...
exports.parseUrl = function parseUrl(url) {
  ...
  // TODO: revise this; details of Url.parse() might have changed over node versions
  ...
  container.path = (parsedUrl.pathname || '/') + container.queryparms + container.hash;
    // TODO: would we really call this a 'path'?
